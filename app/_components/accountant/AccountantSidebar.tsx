...
const NAV = [
  { href: "/accountant", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/accountant/students", icon: GraduationCap, label: "Students" },
  { href: "/accountant/fees", icon: Receipt, label: "Fees" },
];
