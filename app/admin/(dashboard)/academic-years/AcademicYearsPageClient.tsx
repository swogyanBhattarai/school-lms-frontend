...
export default function AcademicYearsPageClient() {
          ...
          <div className="px-6 pt-6 pb-4">
            <DialogHeader className="space-y-1.5">
              ...
              <DialogDescription className="text-sm leading-relaxed">
                {editingClassId ? "Update the class grade." : "Add a new class to the academic year."}
              </DialogDescription>
            </DialogHeader>
          </div>
          <div className="border-t" />
        ...
        <DialogContent className="sm:max-w-md p-0 gap-0 rounded-2xl">
            ...
            <DialogHeader className="space-y-1.5">
              ...
              <DialogDescription className="text-sm leading-relaxed">
                {editingSectionId
                  ...
                  : "Add a new section to the class."}
              </DialogDescription>
            </DialogHeader>
          </div>
          <div className="border-t" />
          ...
          <div className="px-6 py-4 flex items-center justify-between">
            ...
            <Button onClick={handleSaveSection} className="gap-2 text-sm font-medium">
              {editingSectionId ? (
                <>
                  <Pencil className="h-4 w-4" /> Update Section
                </>
              ) : (
                <>
