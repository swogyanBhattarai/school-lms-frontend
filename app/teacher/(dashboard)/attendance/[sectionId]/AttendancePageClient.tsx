...
export default function AttendancePageClient() {
  ...
  const resetAll = () => {
    setStudentStates((prev) => prev.map((s) => ({ ...s, status: "PRESENT" })));
  };
  ...
  const confirmSave = () => {
    const payload: MassAttendance = {
      ...
      studentAttendances: studentStates.map((s) => ({
        studentId: s.studentId,
    ...
    <div className="flex flex-col gap-4 sm:gap-6 pb-24 sm:pb-28">
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-6">
          <div className="md:col-span-2 relative overflow-hidden rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-4 sm:p-6 shadow-sm">
